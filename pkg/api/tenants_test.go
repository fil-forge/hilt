...
func setupProvision(t *testing.T, cfg *setupConfig) (*echo.Echo, *provisionDeps) {
	...
	svc := tenantsvc.New(zap.NewNop(), deps.tenants, deps.providers, bucketmemory.New(), accesskeymemory.New(), principalmemory.New(), policymemory.New(), delegationmemory.New(), deps.secrets, deps.wrapKeys, plcClient, upload)
...
func TestGetTenantHandler(t *testing.T) {
	...
	svc := tenantsvc.New(zap.NewNop(), tenants, providermemory.New(), bucketmemory.New(), accesskeymemory.New(), principalmemory.New(), policymemory.New(), delegationmemory.New(), vaultmemory.New(), wrapkeymemory.New(), nil, nil)
...
func setupDelete(t *testing.T, status tenant.Status) (*echo.Echo, *deleteDeps) {
	...
	svc := tenantsvc.New(zap.NewNop(), deps.tenants, providermemory.New(), deps.buckets, deps.accessKeys, principalmemory.New(), policymemory.New(), deps.delegations, deps.secrets, deps.wrapKeys, plcClient, nil)
