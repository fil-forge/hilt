...
// chain(s) that reach it: the chains to the credential's own grants for a
// service credential, and the bucket root plus the key's marker for a
// principal-bound key. It
