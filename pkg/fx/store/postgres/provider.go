...
import (
	...
	pgexportsession "github.com/fil-forge/hilt/pkg/store/exportsession/postgres"
...
func NewExportSessionStore(mdb *MigratedPool) exportsession.Store {
	return pgexportsession.New(mdb.Pool)
}
